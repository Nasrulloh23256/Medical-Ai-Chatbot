...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereMessage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereResponse($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ChatHistory>|ChatHistory query()
     ...
     */
    class ChatHistory extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereProfilePictureUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereLatitude($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereLongitude($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor wherePhoneNumber($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Voucher>|Voucher whereIsUsed($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Voucher>|Voucher whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Voucher>|Voucher whereUsedAt($value)
